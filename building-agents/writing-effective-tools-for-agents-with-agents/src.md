...
![Building an evaluation allows you to systematically measure the performance of your tools. You can use Claude Code to automatically optimize your tools against this evaluation.](engineer-claude-code-eval-tools.png)
...
![Held-out test set performance of our internal Slack tools](slack-mcp-test-accuracy.png)
...
![Held-out test set performance of our internal Asana tools](asana-mcp-test-accuracy.png)
...
![Example of a detailed tool response](detailed-tool-response.png)

Here's an example of a concise tool response (72 tokens):

![Example of a concise tool response](concise-tool-response.png)
...
![Example of a truncated tool response](truncated-tool-response.png)

Here's an example of an unhelpful error response:

![Example of an unhelpful error response](unhelpful-error-response.png)

Here's an example of a helpful error response:

![Example of a helpful error response](helpful-error-response.png)
